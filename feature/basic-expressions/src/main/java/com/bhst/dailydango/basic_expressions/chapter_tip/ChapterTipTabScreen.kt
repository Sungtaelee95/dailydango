...
fun ChapterTipTabContent(
    ...
    Column(
        ...
        Text(
            text = "$chapter" + stringResource(R.string.info_before_study_chapter),
...
fun ChapterTipContentTabPreview() {
    DailyDangoTheme {
        ChapterTipTabContent(
            tips = listOf(
                Tip(
