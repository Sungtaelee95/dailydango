...
@HiltViewModel
class QuizChapterViewModel @Inject constructor(
    private val quizChapterUseCase: QuizChapterUseCase,
    private val quizChapterLimitUseCase: QuizChapterLimitUseCase,
    ...
    fun getChapters() {
        ...
        viewModelScope.launch {
            ...
            var limit: Int
            when (val result = quizChapterLimitUseCase()) {
            ...
            when (val result = quizChapterUseCase()) {
