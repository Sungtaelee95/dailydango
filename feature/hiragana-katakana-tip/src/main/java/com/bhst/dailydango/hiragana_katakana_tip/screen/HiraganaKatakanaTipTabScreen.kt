...
@Composable
fun HiraganaKatakanaTipTabScreen(
...
@Composable
fun HiraganaKatakanaTipTabContent(
    ...
    Column(
        ...
        HorizontalPager(
            ...
            when (page) {
                0 -> TipsTabScreen(tips = hiraganaTips, navigateTo = navigateToHiraganaStudy)
                1 -> TipsTabScreen(tips = katakanaTips, navigateTo = navigateToKatakanaStudy)
            }
        }
    }
}
...
fun HiraganaKatakanaTipTabContentPreview(){
    DailyDangoTheme {
        HiraganaKatakanaTipTabContent()
    }
}