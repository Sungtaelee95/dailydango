...
class QuizChapterLimitRepositoryImpl @Inject constructor(
    ...
    override suspend fun getChapterLimit(): ChapterLimitResult {
        return withContext(IO) {
            try {
                ...
                val document = fb.collection(COLLECTION_LIMIT_QUIZ)
    ...
    companion object {
        private const val COLLECTION_LIMIT_QUIZ = "limit_quiz"
