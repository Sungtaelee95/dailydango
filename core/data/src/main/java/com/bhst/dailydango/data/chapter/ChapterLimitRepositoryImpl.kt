...
class ChapterLimitRepositoryImpl @Inject constructor(
    ...
    override suspend fun getChapterLimit(): ChapterLimitResult {
        return withContext(IO) {
            try {
                ...
                val document = fb.collection(COLLECTION_LIMIT_CHAPTER)
    ...
    companion object {
        private const val COLLECTION_LIMIT_CHAPTER = "limit_chapter"
        private const val DOC_LIMIT_CONFIG = "limit_config"
    }
}