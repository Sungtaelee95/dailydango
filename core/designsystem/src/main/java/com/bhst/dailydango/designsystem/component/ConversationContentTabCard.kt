...
fun ConversationContentTabCard(
    ...
    Surface(
        ...
        Column(
            ...
            ConversationContentTabCardTop(
                contentState = contentState,
                updateContent = updateContent,
                allSpeakClick = allSpeakClick,
            )
            if (contentState.isOpen) {
                ConversationContentTabCardBottom(
                    contentState = contentState,
...
@Composable
fun ConversationContentTabCardBottom(
    contentState: ConversationContentState,
    speakerClick: (Uri?) -> Unit = {},
...
@Composable
fun ConversationContentTabCardTop(
    contentState: ConversationContentState,
    updateContent: (ConversationContentState) -> Unit = {},
    allSpeakClick: (List<Uri>) -> Unit = {},
) {
...
fun ConversationContentTabCardPreview() {
    DailyDangoTheme {
