...
private val DarkColorScheme = darkColorScheme(
    primary = DailyDangoColor.WildStrawberry,
    primaryContainer = DailyDangoColor.NearBlack,
    onPrimaryContainer = DailyDangoColor.AppleGreen,
    inversePrimary = DailyDangoColor.DarkGreen,
    secondary = DailyDangoColor.CarrotOrange,
    background = DailyDangoColor.DarkCharcoal,
    onBackground = DailyDangoColor.SnowWhite,
    surface = DailyDangoColor.White,
    onSurface = DailyDangoColor.Black,
    outline = DailyDangoColor.PalePink,
    scrim = DailyDangoColor.MediumGray
)

// 🔵 라이트 테마 컬러 스킴
private val LightColorScheme = lightColorScheme(
    primary = DailyDangoColor.WildStrawberry,
    primaryContainer = DailyDangoColor.WhisperWhite,
    onPrimaryContainer = DailyDangoColor.AppleGreen,
    inversePrimary = DailyDangoColor.MaterialGreen,
    secondary = DailyDangoColor.CarrotOrange,
    background = DailyDangoColor.IvoryWhite,
    onBackground = DailyDangoColor.SoftBlack,
    surface = DailyDangoColor.White,
    onSurface = DailyDangoColor.Black,
    outline = DailyDangoColor.PalePink,
    scrim = DailyDangoColor.MediumGray
